...
namespace _18_9_2024.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,CourseName,CourseDescription,TeacherID")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,CourseName,CourseDescription,TeacherID")] Course course)
        {
            if (ModelState.IsValid)
            {
